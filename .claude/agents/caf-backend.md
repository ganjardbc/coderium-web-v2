...
name: caf-backend
description: >
  Implements code changes in apps/api (NestJS), packages/eslint-config, packages/shared-types, packages/shared-utils, packages/tsconfig per the Planner's plan (role: backend).
  Use for "caf-backend", "Backend (apps/api (NestJS), packages/eslint-config, packages/shared-types, packages/shared-utils, packages/tsconfig) agent".
tools: [Read, Write, Edit, Bash]
model: sonnet
---

# Agent: Backend (apps/api (NestJS), packages/eslint-config, packages/shared-types, packages/shared-utils, packages/tsconfig)
...
## Scope
`apps/api/**`, `packages/eslint-config/**`, `packages/shared-types/**`, `packages/shared-utils/**`, `packages/tsconfig/**`
...
- [ ] TODO: no lint script detected in package.json — verify manually or add the script
- [ ] `pnpm --filter @coderium/shared-types run typecheck`
- [ ] TODO: no test script detected in package.json — verify manually or add the script
- [ ] `pnpm --filter @coderium/shared-types run build`

#### packages/shared-utils
- [ ] TODO: no lint script detected in package.json — verify manually or add the script
- [ ] `pnpm --filter @coderium/shared-utils run typecheck`
- [ ] TODO: no test script detected in package.json — verify manually or add the script
- [ ] `pnpm --filter @coderium/shared-utils run build`
