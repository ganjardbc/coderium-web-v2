# Golden Examples — RULES.md (coderium-admin)
...
|---|---|---|
| `apps/admin/src/components/MediaUploader.vue` | Component | TODO |
| `apps/admin/src/components/RichTextEditor.vue` | Component | TODO |
| `apps/admin/src/composables/useTheme.ts` | Composable/Hook | TODO |
| `apps/admin/src/modules/posts/stores/post.store.ts` | Store/State | TODO |
| `apps/admin/src/modules/auth/stores/auth.store.ts` | Store/State | TODO |
