<template>
  <div class="p-6">
    <div class="flex items-center justify-between mb-6">
      ...
      <router-link to="/playlists/new" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm">
        + New Playlist
      </router-link>
    </div>
      ...
      <table class="w-full">
        ...
        <tbody>
          <tr v-for="pl in playlists" :key="pl.id" class="border-b last:border-0 hover:bg-gray-50">
            <td class="px-4 py-3">
              <router-link :to="`/playlists/edit/${pl.slug}`" class="text-blue-600 hover:underline font-medium">
                {{ pl.title }}
              </router-link>
            </td>
            <td class="px-4 py-3">
            ...
            <td class="px-4 py-3 text-right">
              <div class="flex justify-end gap-2">
                ...
                <router-link :to="`/playlists/edit/${pl.slug}`" class="text-xs text-blue-600 hover:underline">Edit</router-link>
