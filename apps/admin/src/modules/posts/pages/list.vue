  ...
  <div class="p-6">
    <div class="flex items-center justify-between mb-6">
      ...
      <div class="flex gap-2">
        <router-link to="/posts/create?type=article" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm">
          + Article
        </router-link>
        <router-link to="/posts/create?type=carousel" class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 text-sm">
          + Carousel
        </router-link>
        <router-link to="/posts/create?type=video" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 text-sm">
          + Video
        </router-link>
        <router-link to="/posts/create?type=stack_gallery" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 text-sm">
          + Gallery
        </router-link>
      </div>
    </div>
      ...
      <table class="w-full">
        ...
        <tbody>
          <tr v-for="post in posts" :key="post.id" class="border-b last:border-0 hover:bg-gray-50">
            <td class="px-4 py-3">
              <router-link :to="`/posts/${post.slug}/edit`" class="text-blue-600 hover:underline font-medium">
                {{ post.title }}
              </router-link>
            </td>
            <td class="px-4 py-3">
            ...
            <td class="px-4 py-3 text-right">
              <div class="flex justify-end gap-2">
                ...
                >Unpublish</button>
                <router-link :to="`/posts/${post.slug}/edit`" class="text-xs text-blue-600 hover:underline">Edit</router-link>
