# Golden Examples — RULES.md (coderium-api)
...
|---|---|---|
| `apps/api/src/analytics/analytics.controller.ts` | Controller/Route Handler | TODO |
| `apps/api/src/auth/auth.controller.ts` | Controller/Route Handler | TODO |
| `apps/api/src/engagement/engagement.controller.ts` | Controller/Route Handler | TODO |
| `apps/api/src/search/search.service.ts` | Service/Business Logic | TODO |
| `apps/api/src/users/users.service.ts` | Service/Business Logic | TODO |
| `apps/api/src/engagement/engagement.service.ts` | Service/Business Logic | TODO |
| `apps/api/src/search/search.dto.ts` | DTO/Validation | TODO |
| `apps/api/src/posts/dto/create-post.dto.ts` | DTO/Validation | TODO |
| `apps/api/src/media/dto/index.ts` | DTO/Validation | TODO |
