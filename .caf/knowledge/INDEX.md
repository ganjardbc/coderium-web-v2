...
| Dokumen | Path | Status |
|---|---|---|
| PRD | `docs/product/prd.md` | ✗ belum ada |
| System Overview | `docs/architecture/system-overview.md` | ✗ belum ada |
| ERD | `docs/schema/erd.md` | ✗ belum ada |
| Testing Strategy | `docs/testing-strategy.md` | ✗ belum ada |
| API Contract | `docs/api-contract.md` | ✗ belum ada |

Jalankan `caf-init docs` untuk generate placeholder kosong bagi dokumen yang belum
