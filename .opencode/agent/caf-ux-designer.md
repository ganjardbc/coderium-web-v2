...
`.caf/discovery/{slug}/prd.md` dari PM Agent (wajib) — kalau file itu belum ada, STOP dan laporkan; jangan mulai dari asumsi.

## Output
Menghasilkan `flow.md` di `.caf/discovery/{slug}/` untuk direview manusia. Bukan mockup visual dan bukan spesifikasi komponen — deskripsi alur, state, dan kondisi gagal.
