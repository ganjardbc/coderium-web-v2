...
eksternal (Linear, Jira, GitHub, dst).
...
Fokus pada pola-pola berikut (TODO: sesuaikan/tambah berdasarkan konvensi dan
invariant project ini — cek CLAUDE.md dan riwayat incident/hotfix kalau ada):
- Query/endpoint yang tidak melakukan validasi scope tenant/organisasi/akun
  (kalau project ini punya konsep multi-tenancy — cek CLAUDE.md)
...
Lokasi: `.ai/audits/<DATE>/audit-report-{scope-slug}.md`
...
Kalau folder `.ai/audits/<DATE>/` belum ada, buat dulu.

**Kalau file `.ai/audits/<DATE>/audit-report-{scope-slug}.md` sudah ada**
