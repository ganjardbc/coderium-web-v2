<template>
  ...
  >
    <img
      ...
      :src="product.cover"
      :alt="product.name"
      class="absolute inset-0 w-full h-full object-cover opacity-90 group-hover:opacity-100 group-hover:scale-[1.03] transition-all duration-500"
    />
    ...
    <div class="absolute inset-0 flex flex-col justify-end p-6 md:p-10">
      ...
      <span
        class="mt-4 inline-flex items-center gap-1.5 w-fit text-sm font-medium text-white group-hover:gap-2.5 transition-all"
      >
        Explore product
