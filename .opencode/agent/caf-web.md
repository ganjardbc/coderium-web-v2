...
name: caf-web
description: >
  Mengimplementasikan perubahan kode di apps/web (Nuxt) sesuai rencana dari Planner.
  Gunakan untuk "caf-web", "apps/web agent (Nuxt) (di luar routing caf-orchestrator) agent".
tools:
  read: true
  write: true
  edit: true
...
# Agent: apps/web agent (Nuxt) (di luar routing caf-orchestrator)
