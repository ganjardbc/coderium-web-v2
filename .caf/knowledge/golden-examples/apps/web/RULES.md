# Golden Examples — RULES.md (coderium-web)
...
|---|---|---|
| `apps/web/components/BackButton.vue` | Component | TODO |
| `apps/web/components/PostActionBar.vue` | Component | TODO |
| `apps/web/components/PostListItem.vue` | Component | TODO |
| `apps/web/composables/useFormatters.ts` | Composable/Hook | TODO |
